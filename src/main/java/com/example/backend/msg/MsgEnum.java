...
public enum MsgEnum {
    ...
    TURTLE_ONE_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/t1.gif"),
    TURTLE_TWO_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/t2.gif"),
    TURTLE_THIRD_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/t3.gif"),
    SLOTH_ONE_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/s1.gif"),
    SLOTH_TWO_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/s2.gif"),
    SLOTH_THIRD_URL("https://ohnigabucket.s3.ap-northeast-2.amazonaws.com/gifcompressor/s3.gif"),
